...
struct KeyboardLayout {
    ...
    /// This is the layout of the GS65 keyboard with the corresponding key code
    ...
    /// This is the layout of the PerKey ( every other per-key rgb keys other than GS65)  keyboard with the corresponding key code
    ...
    ///There values are needed for the creation of the Color packet. These include null keys of both PerKey and GS65
    static let nullPerKeysAndGS65: [UInt8:String] = [0x39:"NULL",0xf0:"NULL",0x3f:"NULL",0x31:"NULL",0x64:"NULL",0x87:"NULL",0x88:"NULL",0x89:"NULL",0x8A:"NULL",0x8B:"NULL",0x90:"NULL", 0x91:"NULL"]

    /// These are extra null GS65 keys
    static let nullGS65Keys: [UInt8:String] = [0x46:"NULL", 0x47:"NULL",0x48:"NULL",0x52:"NULL"]
    
    // These are extra null PerKey keys
    static let nullPerKey: [UInt8:String] = [0x49:"NULL",0x4c:"NULL",0x63:"NULL"]
}
